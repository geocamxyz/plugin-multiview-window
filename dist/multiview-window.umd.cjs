(function(v,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(v=typeof globalThis<"u"?globalThis:v||self,s(v.MultiviewWindow={}))})(this,function(v){"use strict";const s=(x,f={},l="")=>{const i=document.createElement(x);for(let u in f)i.setAttribute(u,f[u]);return i.innerHTML=l,i},E=(x,f)=>(document.getElementById(x)||document.getElementsByTagName("head")[0].prepend(s("STYLE",{type:"text/css"},f)),!0),U=function(x={}){const f={map:"geocam-floating-window",split:"geocam-split-window",image:"geocam-base-window"};let l,i,u,c=null,e=x.mapElement,d="map";E("geocam-multiview-window",`
    .geocam-base-window {
      position: absolute;
      z-index: 0;
    }
  ...
  `);const $=[["left","top"],["move"],["width","top"],["left"],[],["width"],["left","height"],["height"],["width","height"]];function B(a,o){return+(Math.round(a+"e"+o)+"e-"+o)}const C=function(){return d==="image"&&e?e:i},w=function(a,o){return o||(o=C()),parseFloat(o.style[a])},t=function(a,o,n){n||(n=C()),n.style[a]=`${B(o,2)}%`},L=function(a){i.classList.add("geocam-floating-window-noevents");const o=a.target;if(o.classList.contains("geocam-window-move-handler")){const n=Array.from(o.parentNode.children).indexOf(o);c={x:a.clientX,y:a.clientY,left:w("left"),top:w("top"),width:w("width"),height:w("height"),props:$[n]}}},M=function(a){if(c){const o=a.clientX-c.x,n=a.clientY-c.y,g=o/window.innerWidth*100,r=n/window.innerHeight*100;for(let h=0;h<c.props.length;h++)switch(c.props[h]){case"move":t("top",c.top+r),d!=="split"?t("left",c.left+g):(t("height",c.height-r),e.style.height=`${c.top+r}%`);break;case"left":t("left",c.left+g),t("width",c.width-g),d==="split"&&(e.style.width=`${c.left+g}%`);break;case"top":t("top",c.top+r),t("height",c.height-r);break;case"width":t("width",c.width+g),d==="split"&&(e.style.left=`${c.width+g}%`,e.style.width=`${100-(c.width+g)}%`);break;case"height":t("height",c.height+r),d==="split"&&(e.style.top=`${c.height+r}%`,e.style.height=`${100-(c.height+r)}%`);break}}},z=function(){const a=["left","top","width","height"];for(let o=0;o<a.length;o++){const n=a[o];l.stores[n]?l.stores[n](w(n)):l.store(n,w(n))}l.stores.mode?l.mode(d):l.store("mode",d)},V=function(){c&&(z(),c=null),i.classList.remove("geocam-floating-window-noevents")},b=function(a){a.prepend(u)},H=function(a){switch(console.log("in set window",a,d),d){case"map":switch(b(i),i.classList.remove("geocam-base-window"),i.classList.remove("geocam-split-window"),i.classList.add("geocam-floating-window"),t("width",50),t("height",50),a){case"top-left":t("left",0),t("top",0);break;case"top-right":t("left",50),t("top",0);break;case"bottom-right":t("left",50),t("top",50);break;case"bottom-left":t("left",0),t("top",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));t("left",o.get("left")||0),t("top",o.get("top")||0)}e&&(e.classList.remove("geocam-split-window"),e.classList.remove("geocam-floating-window"),e.classList.add("geocam-base-window"),e.style.left="0%",e.style.top="0%",e.style.width="100%",e.style.height="100%");break;case"split":switch(b(i),i.classList.remove("geocam-base-window"),i.classList.remove("geocam-floating-window"),i.classList.add("geocam-split-window"),a){case"left":t("left",0),t("top",0),t("width",50),t("height",100);break;case"top":t("left",0),t("top",0),t("width",100),t("height",50);break;case"right":t("left",50),t("top",0),t("width",50),t("height",100);break;case"bottom":t("left",0),t("top",50),t("width",100),t("height",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));t("left",o.get("left")||50),t("top",o.get("top")||0),t("width",o.get("width")||50),t("height",o.get("height")||100)}if(e)switch(e.classList.remove("geocam-base-window"),e.classList.remove("geocam-floating-window"),e.classList.add("geocam-split-window"),a){case"left":e.style.left="50%",e.style.top="0%",e.style.width="50%",e.style.height="100%";break;case"top":e.style.left="0%",e.style.top="50%",e.style.width="100%",e.style.height="50%";break;case"right":e.style.left="0%",e.style.top="0%",e.style.width="50%",e.style.height="100%";break;case"bottom":e.style.left="0%",e.style.top="0%",e.style.width="100%",e.style.height="50%";break;default:new URLSearchParams(window.location.hash.substr(1));const[o,n,g,r]=[w("left"),w("top"),w("width"),w("height")];r===100&&n===0?(e.style.top="0%",e.style.height="100%",e.style.left=o>0?"0%":`${100-g}%`,e.style.width=o>0?`${o}%`:`${g}%`,a=o>0?"right":"left"):(e.style.left="0%",e.style.width="100%",e.style.top=n>0?"0%":`${100-r}%`,e.style.height=n>0?`${n}%`:`${r}%`,a=n>0?"bottom":"top")}i.classList.remove("geocam-split-left","geocam-split-right","geocam-split-top","geocam-split-bottom"),i.classList.add(`geocam-split-${a}`);break;case"image":if(i.classList.remove("geocam-split-window"),i.classList.remove("geocam-floating-window"),i.classList.add("geocam-base-window"),i.style.left="0%",i.style.top="0%",i.style.width="100%",i.style.height="100%",e)switch(b(e),e.classList.remove("geocam-split-window"),e.classList.remove("geocam-base-window"),e.classList.add("geocam-floating-window"),t("width",50),t("height",50),a){case"top-left":t("left",0),t("top",0);break;case"top-right":t("left",50),t("top",0);break;case"bottom-right":t("left",50),t("top",50);break;case"bottom-left":t("left",0),t("top",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));e.style.left=`${o.get("left")||50}%`,e.style.top=`${o.get("top")||50}%`,e.style.width=`${o.get("width")||50}%`,e.style.height=`${o.get("height")||50}%`}break}z()};this.setMapElement=function(a){e=a},this.init=function(a){const o=new URLSearchParams(window.location.hash.substr(1));l=a;const n=s("div",{}),g=s("div",{class:"geocam-window-position-button geocam-viewer-control-button",title:"position geocam viewer"});n.appendChild(g);const r=s("div",{class:"relative"}),h=s("div",{class:"geocam-position-menu-wrapper",style:"	padding: 0.25rem;box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);display: none;position: absolute;background-color: rgb(255 255 255);;top: -32px; left: calc(32px + 0.25rem); width: calc(128px + 1.25rem)"}),p=s("div",{class:"geocam-position-menu",style:"display: grid;grid-template-columns: repeat(4, minmax(0, 1fr));	grid-template-rows: repeat(3, minmax(0, 1fr));gap: 0.25rem;"});p.appendChild(s("div",{class:"geocam-position-image-top-left geocam-viewer-control-button ","data-position":"top-left","data-mode":"map",title:"float viewer over the map at the top left"})),p.appendChild(s("div",{class:"geocam-position-image-top-right geocam-viewer-control-button","data-position":"top-right","data-mode":"map",title:"float viewer over the map at the top right"})),p.appendChild(s("div",{class:"geocam-position-image-bottom-right geocam-viewer-control-button","data-position":"bottom-right","data-mode":"map",title:"float viewer over the map at the bottom right"})),p.appendChild(s("div",{class:"geocam-position-image-bottom-left geocam-viewer-control-button","data-position":"bottom-left","data-mode":"map",title:"float viewer over the map at the bottom left"})),p.appendChild(s("div",{class:"geocam-position-split-left geocam-viewer-control-button","data-position":"left","data-mode":"split",title:"split the window with viewer on the left and map on the right"})),p.appendChild(s("div",{class:"geocam-position-split-top geocam-viewer-control-button","data-position":"top","data-mode":"split",title:"split the window with viewer on the top and map on the bottom"})),p.appendChild(s("div",{class:"geocam-position-split-right geocam-viewer-control-button","data-position":"right","data-mode":"split",title:"split the window with viewer on the right and map on the left"})),p.appendChild(s("div",{class:"geocam-position-split-bottom geocam-viewer-control-button","data-position":"bottom","data-mode":"split",title:"split the window with viewer on the bottom and map on the top"})),p.appendChild(s("div",{class:"geocam-position-map-top-left geocam-viewer-control-button","data-position":"top-left","data-mode":"image",title:"float map over the viewer at the top left"})),p.appendChild(s("div",{class:"geocam-position-map-top-right geocam-viewer-control-button","data-position":"top-right","data-mode":"image",title:"float map over the viewer at the top right"})),p.appendChild(s("div",{class:"geocam-position-map-bottom-right geocam-viewer-control-button","data-position":"bottom-right","data-mode":"image",title:"float map over the viewer at the bottom right"})),p.appendChild(s("div",{class:"geocam-position-map-bottom-left geocam-viewer-control-button","data-position":"bottom-left","data-mode":"image",title:"float map over the viewer at the bottom left"})),h.appendChild(p),r.appendChild(h),n.appendChild(r),l.addControl(n,"left-top",{prepend:!0});const y=function(m){m.target.closest(".geocam-position-menu-wrapper")||h.classList.add("geocam-hidden")};g.addEventListener("click",function(){h.classList.toggle("geocam-hidden"),h.classList.contains("geocam-hidden")?document.removeEventListener("mousedown",y):document.addEventListener("mousedown",y)}),h.addEventListener("click",function(m){const k=m.target;if(k.classList.contains("geocam-viewer-control-button")){h.classList.add("geocam-hidden"),document.removeEventListener("mousedown",y),d=k.getAttribute("data-mode");const F=k.getAttribute("data-position");H(F)}});const T=s("div",{class:"geocam-window-close-button geocam-viewer-control-button",title:"close geocam viewer"});T.addEventListener("click",l.hide),l.addControl(T,"left-top",{prepend:!0}),d=o.get("mode")?JSON.parse(o.get("mode")):d,console.log("mode is",d),i=s("DIV",{class:`${f[d]}`}),u=s("DIV",{class:"geocam-window-move"});for(let m=0;m<9;m++)u.appendChild(s("DIV",{class:m==4?"geocam-window-move-spacer":"geocam-window-move-handler"}));H(),l.wrapper.parentNode.appendChild(i),i.appendChild(l.wrapper),l.visible(m=>{m?i.classList.remove("geocam-viewer-hidden"):i.classList.add("geocam-viewer-hidden")},{prepend:!0}),window.addEventListener("mousedown",L),window.addEventListener("mousemove",M),window.addEventListener("mouseup",V)},this.destroy=function(){window.removeEventListener("mousedown",L),window.removeEventListener("mousemove",M),window.removeEventListener("mouseup",V),i.parentNode.appendChild(l.wrapper),i.parentNode.removeChild(i)}};v.multiviewWindow=U,Object.defineProperty(v,Symbol.toStringTag,{value:"Module"})});
