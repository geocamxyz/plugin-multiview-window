(function(f,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(f=typeof globalThis<"u"?globalThis:f||self,s(f.MultiviewWindow={}))})(this,(function(f){"use strict";const s=(b,v={},l="")=>{const i=document.createElement(b);for(let w in v)i.setAttribute(w,v[w]);return i.innerHTML=l,i},U=(b,v)=>(document.getElementById(b)||document.getElementsByTagName("head")[0].prepend(s("STYLE",{type:"text/css"},v)),!0),$=function(b={}){const v={map:"geocam-floating-window",split:"geocam-split-window",image:"geocam-base-window"};let l,i,w,n=null,e=b.mapElement,d="map";U("geocam-multiview-window",`
    .hidden {
      display: none;
    }
  ...
  `);const B=[["left","top"],["move"],["width","top"],["left"],[],["width"],["left","height"],["height"],["width","height"]];function S(a,o){return+(Math.round(a+"e"+o)+"e-"+o)}const L=function(){return d==="image"&&e?e:i},m=function(a,o){return o||(o=L()),parseFloat(o.style[a])},t=function(a,o,c){c||(c=L()),c.style[a]=`${S(o,2)}%`},M=function(a){i.classList.add("geocam-floating-window-noevents");const o=a.target;if(o.classList.contains("geocam-window-move-handler")){const c=Array.from(o.parentNode.children).indexOf(o);n={x:a.clientX,y:a.clientY,left:m("left"),top:m("top"),width:m("width"),height:m("height"),props:B[c]}}},z=function(a){if(n){const o=a.clientX-n.x,c=a.clientY-n.y,g=o/window.innerWidth*100,r=c/window.innerHeight*100;for(let h=0;h<n.props.length;h++)switch(n.props[h]){case"move":t("top",n.top+r),d!=="split"?t("left",n.left+g):(t("height",n.height-r),e.style.height=`${n.top+r}%`);break;case"left":t("left",n.left+g),t("width",n.width-g),d==="split"&&(e.style.width=`${n.left+g}%`);break;case"top":t("top",n.top+r),t("height",n.height-r);break;case"width":t("width",n.width+g),d==="split"&&(e.style.left=`${n.width+g}%`,e.style.width=`${100-(n.width+g)}%`);break;case"height":t("height",n.height+r),d==="split"&&(e.style.top=`${n.height+r}%`,e.style.height=`${100-(n.height+r)}%`);break}}},V=function(){const a=["left","top","width","height"];for(let o=0;o<a.length;o++){const c=a[o];l.stores[c]?l.stores[c](m(c)):l.store(c,m(c))}l.stores.mode?l.mode(d):l.store("mode",d)},H=function(){n&&(V(),n=null),i.classList.remove("geocam-floating-window-noevents")},x=function(a){a.prepend(w)},E=function(a){switch(console.log("in set window",a,d),d){case"map":switch(x(i),i.classList.remove("geocam-base-window"),i.classList.remove("geocam-split-window"),i.classList.add("geocam-floating-window"),t("width",50),t("height",50),a){case"top-left":t("left",0),t("top",0);break;case"top-right":t("left",50),t("top",0);break;case"bottom-right":t("left",50),t("top",50);break;case"bottom-left":t("left",0),t("top",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));t("left",o.get("left")||0),t("top",o.get("top")||0)}e&&(e.classList.remove("geocam-split-window"),e.classList.remove("geocam-floating-window"),e.classList.add("geocam-base-window"),e.style.left="0%",e.style.top="0%",e.style.width="100%",e.style.height="100%");break;case"split":switch(x(i),i.classList.remove("geocam-base-window"),i.classList.remove("geocam-floating-window"),i.classList.add("geocam-split-window"),a){case"left":t("left",0),t("top",0),t("width",50),t("height",100);break;case"top":t("left",0),t("top",0),t("width",100),t("height",50);break;case"right":t("left",50),t("top",0),t("width",50),t("height",100);break;case"bottom":t("left",0),t("top",50),t("width",100),t("height",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));t("left",o.get("left")||50),t("top",o.get("top")||0),t("width",o.get("width")||50),t("height",o.get("height")||100)}if(e)switch(e.classList.remove("geocam-base-window"),e.classList.remove("geocam-floating-window"),e.classList.add("geocam-split-window"),a){case"left":e.style.left="50%",e.style.top="0%",e.style.width="50%",e.style.height="100%";break;case"top":e.style.left="0%",e.style.top="50%",e.style.width="100%",e.style.height="50%";break;case"right":e.style.left="0%",e.style.top="0%",e.style.width="50%",e.style.height="100%";break;case"bottom":e.style.left="0%",e.style.top="0%",e.style.width="100%",e.style.height="50%";break;default:new URLSearchParams(window.location.hash.substr(1));const[o,c,g,r]=[m("left"),m("top"),m("width"),m("height")];r===100&&c===0?(e.style.top="0%",e.style.height="100%",e.style.left=o>0?"0%":`${100-g}%`,e.style.width=o>0?`${o}%`:`${g}%`,a=o>0?"right":"left"):(e.style.left="0%",e.style.width="100%",e.style.top=c>0?"0%":`${100-r}%`,e.style.height=c>0?`${c}%`:`${r}%`,a=c>0?"bottom":"top")}i.classList.remove("geocam-split-left","geocam-split-right","geocam-split-top","geocam-split-bottom"),i.classList.add(`geocam-split-${a}`);break;case"image":if(i.classList.remove("geocam-split-window"),i.classList.remove("geocam-floating-window"),i.classList.add("geocam-base-window"),i.style.left="0%",i.style.top="0%",i.style.width="100%",i.style.height="100%",e)switch(x(e),e.classList.remove("geocam-split-window"),e.classList.remove("geocam-base-window"),e.classList.add("geocam-floating-window"),t("width",50),t("height",50),a){case"top-left":t("left",0),t("top",0);break;case"top-right":t("left",50),t("top",0);break;case"bottom-right":t("left",50),t("top",50);break;case"bottom-left":t("left",0),t("top",50);break;default:const o=new URLSearchParams(window.location.hash.substr(1));e.style.left=`${o.get("left")||50}%`,e.style.top=`${o.get("top")||50}%`,e.style.width=`${o.get("width")||50}%`,e.style.height=`${o.get("height")||50}%`}break}V()};this.setMapElement=function(a){e=a},this.init=function(a){const o=new URLSearchParams(window.location.hash.substr(1));l=a;const c=s("div",{}),g=s("div",{class:"geocam-window-position-button geocam-viewer-control-button",title:"position geocam viewer"});c.appendChild(g);const r=s("div",{class:"relative"}),h=s("div",{class:"absolute bg-white p-1 shadow hidden geocam-position-menu-wrapper",style:"top: -32px; left: calc(32px + 0.25rem); width: calc(128px + 1.25rem)"}),p=s("div",{class:"geocam-position-menu grid grid-cols-4 grid-rows-3 gap-1"});p.appendChild(s("div",{class:"geocam-position-image-top-left geocam-viewer-control-button ","data-position":"top-left","data-mode":"map",title:"float viewer over the map at the top left"})),p.appendChild(s("div",{class:"geocam-position-image-top-right geocam-viewer-control-button","data-position":"top-right","data-mode":"map",title:"float viewer over the map at the top right"})),p.appendChild(s("div",{class:"geocam-position-image-bottom-right geocam-viewer-control-button","data-position":"bottom-right","data-mode":"map",title:"float viewer over the map at the bottom right"})),p.appendChild(s("div",{class:"geocam-position-image-bottom-left geocam-viewer-control-button","data-position":"bottom-left","data-mode":"map",title:"float viewer over the map at the bottom left"})),p.appendChild(s("div",{class:"geocam-position-split-left geocam-viewer-control-button","data-position":"left","data-mode":"split",title:"split the window with viewer on the left and map on the right"})),p.appendChild(s("div",{class:"geocam-position-split-top geocam-viewer-control-button","data-position":"top","data-mode":"split",title:"split the window with viewer on the top and map on the bottom"})),p.appendChild(s("div",{class:"geocam-position-split-right geocam-viewer-control-button","data-position":"right","data-mode":"split",title:"split the window with viewer on the right and map on the left"})),p.appendChild(s("div",{class:"geocam-position-split-bottom geocam-viewer-control-button","data-position":"bottom","data-mode":"split",title:"split the window with viewer on the bottom and map on the top"})),p.appendChild(s("div",{class:"geocam-position-map-top-left geocam-viewer-control-button","data-position":"top-left","data-mode":"image",title:"float map over the viewer at the top left"})),p.appendChild(s("div",{class:"geocam-position-map-top-right geocam-viewer-control-button","data-position":"top-right","data-mode":"image",title:"float map over the viewer at the top right"})),p.appendChild(s("div",{class:"geocam-position-map-bottom-right geocam-viewer-control-button","data-position":"bottom-right","data-mode":"image",title:"float map over the viewer at the bottom right"})),p.appendChild(s("div",{class:"geocam-position-map-bottom-left geocam-viewer-control-button","data-position":"bottom-left","data-mode":"image",title:"float map over the viewer at the bottom left"})),h.appendChild(p),r.appendChild(h),c.appendChild(r),l.addControl(c,"left-top",{prepend:!0});const y=function(u){u.target.closest(".geocam-position-menu-wrapper")||h.classList.add("hidden")};g.addEventListener("click",function(){h.classList.toggle("hidden"),h.classList.contains("hidden")?document.removeEventListener("mousedown",y):document.addEventListener("mousedown",y)}),h.addEventListener("click",function(u){const k=u.target;if(k.classList.contains("geocam-viewer-control-button")){h.classList.add("hidden"),document.removeEventListener("mousedown",y),d=k.getAttribute("data-mode");const F=k.getAttribute("data-position");E(F)}});const T=s("div",{class:"geocam-window-close-button geocam-viewer-control-button",title:"close geocam viewer"});T.addEventListener("click",l.hide),l.addControl(T,"left-top",{prepend:!0}),d=o.get("mode")?JSON.parse(o.get("mode")):d,console.log("mode is",d),i=s("DIV",{class:`${v[d]}`}),w=s("DIV",{class:"geocam-window-move"});for(let u=0;u<9;u++)w.appendChild(s("DIV",{class:u==4?"geocam-window-move-spacer":"geocam-window-move-handler"}));E(),l.wrapper.parentNode.appendChild(i),i.appendChild(l.wrapper),l.visible(u=>{u?i.classList.remove("geocam-viewer-hidden"):i.classList.add("geocam-viewer-hidden")},{prepend:!0}),window.addEventListener("mousedown",M),window.addEventListener("mousemove",z),window.addEventListener("mouseup",H)},this.destroy=function(){window.removeEventListener("mousedown",M),window.removeEventListener("mousemove",z),window.removeEventListener("mouseup",H),i.parentNode.appendChild(l.wrapper),i.parentNode.removeChild(i)}};class C extends HTMLElement{constructor(){super(),this.plugin=null,console.log("multiview-window init")}connectedCallback(){console.log("multiview-window connected");const v=this.closest("geocam-viewer");if(!v){console.error("GeocamViewerMultiviewWindow must be a child of GeocamViewer");return}const l=()=>{const i=v.viewer;if(i&&typeof i.plugin=="function"){const w=this.getAttribute("target"),n=document.getElementById(w)||document.querySelector(w);if(!n){console.error(`multiview-window: target '${w}' not found`);return}this.viewer=i,this.plugin=new $({mapElement:n}),this.viewer.plugin(this.plugin)}else setTimeout(l,50)};l()}disconnectedCallback(){this.plugin=null,this.viewer=null,console.log("multiview-window disconnected")}}window.customElements.define("geocam-viewer-multiview-window",C),f.GeocamViewerMultiviewWindow=C,Object.defineProperty(f,Symbol.toStringTag,{value:"Module"})}));
