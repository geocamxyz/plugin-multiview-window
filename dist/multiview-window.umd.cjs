(function(v,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(v=typeof globalThis<"u"?globalThis:v||self,s(v.MultiviewWindow={}))})(this,function(v){"use strict";const s=(b,f={},l="")=>{const i=document.createElement(b);for(let u in f)i.setAttribute(u,f[u]);return i.innerHTML=l,i},E=(b,f)=>(document.getElementById(b)||document.getElementsByTagName("head")[0].prepend(s("STYLE",{type:"text/css"},f)),!0),U=function(b={}){const f={map:"geocam-floating-window",split:"geocam-split-window",image:"geocam-base-window"};let l,i,u,c=null,e=b.mapElement,r="map";E("geocam-multiview-window",`
    .geocam-base-window {
      position: absolute;
      z-index: 0;
    }
