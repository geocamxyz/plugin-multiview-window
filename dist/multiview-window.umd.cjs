(function(u,s){typeof exports=="object"&&typeof module<"u"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(u=typeof globalThis<"u"?globalThis:u||self,s(u.MultiviewWindow={}))})(this,function(u){"use strict";const s=(f,v={},l="")=>{const i=document.createElement(f);for(let b in v)i.setAttribute(b,v[b]);return i.innerHTML=l,i},U=(f,v)=>(document.getElementById(f)||document.getElementsByTagName("head")[0].prepend(s("STYLE",{type:"text/css"},v)),!0),$=function(f={}){const v={map:"geocam-floating-window",split:"geocam-split-window",image:"geocam-base-window"};let l,i,b,n=null,e=f.mapElement,d="map";U("geocam-multiview-window",`
    .hidden {
      display: none;
    }
