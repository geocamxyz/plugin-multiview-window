const n = (u, v = {}, l = "") => {
...
}, $ = (u, v) => (document.getElementById(u) || document.getElementsByTagName("head")[0].prepend(n("STYLE", { type: "text/css" }, v)), !0), F = function(u = {}) {
  const v = {
    map: "geocam-floating-window",
    split: "geocam-split-window",
    image: "geocam-base-window"
  };
  let l, i, f, s = null, t = u.mapElement, d = "map";
  ...
  const k = function() {
    return d === "image" && t ? t : i;
  }, w = function(a, o) {
    return o || (o = k()), parseFloat(o.style[a]);
  }, e = function(a, o, c) {
    c || (c = k()), c.style[a] = `${U(o, 2)}%`;
  }, C = function(a) {
    ...
    if (s) {
      ...
      for (let h = 0; h < s.props.length; h++)
        switch (s.props[h]) {
          case "move":
            e("top", s.top + r), d !== "split" ? e("left", s.left + g) : (e("height", s.height - r), t.style.height = `${s.top + r}%`);
            break;
          case "left":
            e("left", s.left + g), e("width", s.width - g), d === "split" && (t.style.width = `${s.left + g}%`);
            break;
          case "top":
            e("top", s.top + r), e("height", s.height - r);
            break;
          case "width":
            e("width", s.width + g), d === "split" && (t.style.left = `${s.width + g}%`, t.style.width = `${100 - (s.width + g)}%`);
            break;
          case "height":
            e("height", s.height + r), d === "split" && (t.style.top = `${s.height + r}%`, t.style.height = `${100 - (s.height + r)}%`);
            break;
        }
    }
  }, M = function() {
    ...
    switch (console.log("in set window", a, d), d) {
      case "map":
        switch (b(i), i.classList.remove("geocam-base-window"), i.classList.remove("geocam-split-window"), i.classList.add("geocam-floating-window"), e("width", 50), e("height", 50), a) {
          case "top-left":
            e("left", 0), e("top", 0);
            break;
          case "top-right":
          ...
          default:
            ...
            e("left", o.get("left") || 0), e("top", o.get("top") || 0);
        }
        t && (t.classList.remove("geocam-split-window"), t.classList.remove("geocam-floating-window"), t.classList.add("geocam-base-window"), t.style.left = "0%", t.style.top = "0%", t.style.width = "100%", t.style.height = "100%");
        break;
      case "split":
        switch (b(i), i.classList.remove("geocam-base-window"), i.classList.remove("geocam-floating-window"), i.classList.add("geocam-split-window"), a) {
          case "left":
            e("left", 0), e("top", 0), e("width", 50), e("height", 100);
            break;
          case "top":
            e("left", 0), e("top", 0), e("width", 100), e("height", 50);
            break;
          case "right":
            e("left", 50), e("top", 0), e("width", 50), e("height", 100);
            break;
          case "bottom":
            e("left", 0), e("top", 50), e("width", 100), e("height", 50);
            break;
          default:
            const o = new URLSearchParams(
              window.location.hash.substr(1)
            );
            e("left", o.get("left") || 50), e("top", o.get("top") || 0), e("width", o.get("width") || 50), e("height", o.get("height") || 100);
        }
        if (t)
          switch (t.classList.remove("geocam-base-window"), t.classList.remove("geocam-floating-window"), t.classList.add("geocam-split-window"), a) {
            case "left":
              t.style.left = "50%", t.style.top = "0%", t.style.width = "50%", t.style.height = "100%";
              break;
            case "top":
              t.style.left = "0%", t.style.top = "50%", t.style.width = "100%", t.style.height = "50%";
              break;
            case "right":
              t.style.left = "0%", t.style.top = "0%", t.style.width = "50%", t.style.height = "100%";
              break;
            case "bottom":
              t.style.left = "0%", t.style.top = "0%", t.style.width = "100%", t.style.height = "50%";
              break;
            default:
              new URLSearchParams(
                window.location.hash.substr(1)
              ...
              r === 100 && c === 0 ? (t.style.top = "0%", t.style.height = "100%", t.style.left = o > 0 ? "0%" : `${100 - g}%`, t.style.width = o > 0 ? `${o}%` : `${g}%`, a = o > 0 ? "right" : "left") : (t.style.left = "0%", t.style.width = "100%", t.style.top = c > 0 ? "0%" : `${100 - r}%`, t.style.height = c > 0 ? `${c}%` : `${r}%`, a = c > 0 ? "bottom" : "top");
          }
        i.classList.remove(
          "geocam-split-left",
          "geocam-split-right",
        ...
        break;
      case "image":
        if (i.classList.remove("geocam-split-window"), i.classList.remove("geocam-floating-window"), i.classList.add("geocam-base-window"), i.style.left = "0%", i.style.top = "0%", i.style.width = "100%", i.style.height = "100%", t)
          switch (b(t), t.classList.remove("geocam-split-window"), t.classList.remove("geocam-base-window"), t.classList.add("geocam-floating-window"), e("width", 50), e("height", 50), a) {
            case "top-left":
              e("left", 0), e("top", 0);
              break;
            case "top-right":
            ...
            default:
              ...
              t.style.left = `${o.get("left") || 50}%`, t.style.top = `${o.get("top") || 50}%`, t.style.width = `${o.get("width") || 50}%`, t.style.height = `${o.get("height") || 50}%`;
          }
        break;
    }
    M();
  ...
  this.setMapElement = function(a) {
    ...
    g.addEventListener("click", function() {
      ...
      if (y.classList.contains("geocam-viewer-control-button")) {
        ...
        const T = y.getAttribute("data-position");
        V(T);
      }
    });
    const H = n("div", {
