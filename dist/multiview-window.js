const n = (u, v = {}, l = "") => {
  ...
  const k = function() {
    ...
    switch (console.log("in set window", a, d), d) {
      case "map":
        switch (x(i), i.classList.remove("geocam-base-window"), i.classList.remove("geocam-split-window"), i.classList.add("geocam-floating-window"), t("width", 50), t("height", 50), a) {
          case "top-left":
            t("left", 0), t("top", 0);
            break;
          case "top-right":
        ...
        break;
      case "split":
        switch (x(i), i.classList.remove("geocam-base-window"), i.classList.remove("geocam-floating-window"), i.classList.add("geocam-split-window"), a) {
          case "left":
      ...
      case "image":
        if (i.classList.remove("geocam-split-window"), i.classList.remove("geocam-floating-window"), i.classList.add("geocam-base-window"), i.style.left = "0%", i.style.top = "0%", i.style.width = "100%", i.style.height = "100%", e)
          switch (x(e), e.classList.remove("geocam-split-window"), e.classList.remove("geocam-base-window"), e.classList.add("geocam-floating-window"), t("width", 50), t("height", 50), a) {
            case "top-left":
              t("left", 0), t("top", 0);
              break;
            case "top-right":
  ...
  this.setMapElement = function(a) {
    ...
    const r = n("div", { class: "relative" }), h = n("div", {
      ...
      style: "	padding: 0.25rem;box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);display: none;position: absolute;background-color: rgb(255 255 255);;top: -32px; left: calc(32px + 0.25rem); width: calc(128px + 1.25rem)"
    }), p = n("div", {
    ...
    const b = function(m) {
      m.target.closest(".geocam-position-menu-wrapper") || h.classList.add("geocam-hidden");
    };
    g.addEventListener("click", function() {
      h.classList.toggle("geocam-hidden"), h.classList.contains("geocam-hidden") ? document.removeEventListener("mousedown", b) : document.addEventListener("mousedown", b);
    }), h.addEventListener("click", function(m) {
      const y = m.target;
      if (y.classList.contains("geocam-viewer-control-button")) {
        h.classList.add("geocam-hidden"), document.removeEventListener("mousedown", b), d = y.getAttribute("data-mode");
